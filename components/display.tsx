    ...
    <div className="flex flex-col ml-[30px] mt-[20px] p-0 w-[275px] h-[225px] bg-[#d3d3d3] rounded-r rounded-tl rounded-bl-[50px] shadow-[rgba(77,77,77,0.75)_3px_3px_4px_0px] border border-black border-opacity-50 justify-center">
        ...
        <div id="black-screen" className="flex mt-[10px] mx-auto h-[160px] w-[230px] bg-black rounded">
          <div className="flex flex-col items-center">
            <div id="pokemon-name" className="flex h-[30px] w-[115px] justify-center text-sm"></div>
            <div id="pokemon-id" className="flex h-[30px] w-[75px] justify-center"></div>
            <div id="pokemon-weight" className="flex h-[30px] w-[75px] justify-center mb-5"></div>
            <div id="pokemon-height" className="flex h-[30px] w-[75px] justify-center"></div>
          </div>
          <img id="sprite" src="" className="m-auto"></img>
        </div>
